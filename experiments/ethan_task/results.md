...
- `results/processed/ethan_task/Hopper_v4_learning_curves.png`
- `results/processed/ethan_task/Walker2d_v4_learning_curves.png`
- `results/processed/ethan_task/Hopper_v4_auc_summary.png`
- `results/processed/ethan_task/Walker2d_v4_auc_summary.png`

CSV summary: `results/processed/ethan_task/summary.csv`
