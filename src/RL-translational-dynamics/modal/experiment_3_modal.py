...
APP_NAME = "rl-translational-dynamics-experiment-3"
...
def run_training(
    ...
    save_dir: str = str(REMOTE_RESULTS_DIR / "raw" / "experiment_3_reverse_handoff"),
    wandb_project: str = "rl-translational-dynamics",
    wandb_group_prefix: str = "experiment_3_reverse_handoff",
