...
class Args:
    ...
    save_dir: str = "results/raw/experiment_2_fixed_handoff"
    track: bool = False
    wandb_project: str = "rl-translational-dynamics"
    wandb_entity: str | None = None
    wandb_group: str = "experiment_2_fixed_handoff"
...
def main() -> None:
    ...
    for distill_step in range(1, args.distill_steps + 1):
    ...
    warmup_updates = min(args.value_warmup_updates, remaining_updates)
